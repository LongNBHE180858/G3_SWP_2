...
public class QuestionDetailServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<QuestionAnswer> questionAnswers = QuestionAnswerDAO.getQuestionAnswerByQuestionID(questionID);
            List<QuestionMedia> questionMedias = QuestionMediaDAO.getQuestionAnswerByQuestionID(questionID);
            ...
            request.setAttribute("questionMedias", questionMedias);
