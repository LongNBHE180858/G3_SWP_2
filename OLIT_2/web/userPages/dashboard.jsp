    ...
    <head>
        ...
        <style>
            html, body {
                ...
                /* Container giữa header & footer */
                .page-body {
                    flex: 1;               /* chiếm khoảng trống giữa header & footer */
                    display: flex;         /* dùng flex để sidebar & main ngồi cạnh nhau */
                    overflow: hidden;      /* tránh overflow ra ngoài */
                }
