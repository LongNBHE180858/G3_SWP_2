    ...
    <body>
                ...
                <div class="form-section">
                    ...
                    <form id="questionForm">
                        <div class="form-group">
                            ...
                            <input type="text" id="subject" class="form-control" placeholder="Nh?p ch? ??">
                        </div>

                        <div class="form-group">
                            <label for="dimensions">Dimension(s)</label>
                            <input type="text" id="dimensions" class="form-control" placeholder="Nh?p kích th??c">
                        </div>

                        <div class="form-group">
                            <label for="lesson">Lesson</label>
                            <input type="text" id="lesson" class="form-control" placeholder="Nh?p bài h?c">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" class="form-control select">
                                ...
                                <option value="inactive">Không ho?t ??ng</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="content">Content</label>
                            <textarea id="content" class="form-control" rows="3" placeholder="Nh?p n?i dung câu h?i"></textarea>
                        </div>
                        ...
                        <div id="answersContainer">
                            <div class="answer-group">
                                <div class="answer-input">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nh?p câu tr? l?i 1">
                                    <button type="button" class="remove-btn" onclick="removeAnswer(this)">×</button>
                                </div>
                                <div class="explanation-input">
                                    <label>Explanation 1</label>
                                    <input type="text" class="form-control" placeholder="Nh?p gi?i thích cho câu tr? l?i 1">
                                </div>
                            </div>
                            ...
                            <div class="answer-group">
                                <div class="answer-input">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nh?p câu tr? l?i 2">
                                    <button type="button" class="remove-btn" onclick="removeAnswer(this)">×</button>
                                </div>
                                <div class="explanation-input">
                                    <label>Explanation 2</label>
                                    <input type="text" class="form-control" placeholder="Nh?p gi?i thích cho câu tr? l?i 2">
                                </div>
                            </div>
                        </div>
                ...
                <div class="preview-section">
                    ...
                    <div class="preview-content">
                        <div class="preview-placeholder">
                            ...
                            <div>Ch?a có media nào ???c ch?n</div>
                        </div>
                    </div>

                    <div class="description-section">
                        <div class="description-label">Description</div>
                        <textarea class="form-control description-input" placeholder="Nh?p mô t? cho media..."></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="media-upload" onclick="openMediaModal()">
                <div class="media-upload-text">? Qu?n lý media</div>
                <div style="font-size: 12px; color: #888;">Click ?? thêm, s?a ho?c xóa media</div>
            </div>
        </div>
        ...
        <script>
            ...
            function removeMediaItem(button) {
                ...
                if (mediaList.children.length > 1) {
                    ...
                    alert('Ph?i có ít nh?t m?t media item');
                }
            }
            ...
            function updateMediaPreview() {
                ...
                if (totalFiles > 0) {
                    ...
                    previewContent.innerHTML = `
                        <div class="preview-placeholder">
                            <div style="font-size: 48px; margin-bottom: 20px;">?</div>
                            <div>?ã ch?n ${totalFiles} file media</div>
                            <div style="font-size: 14px; color: #888; margin-top: 10px;">
                                Click ?? xem chi ti?t trong popup
                            </div>
                        </div>
                    `;
                }
            ...
            function addAnswer() {
                ...
                newAnswerGroup.innerHTML = `
                    <div class="answer-input">
                        ...
                        <input type="text" class="form-control" placeholder="Nh?p câu tr? l?i ${answerCount}">
                        <button type="button" class="remove-btn" onclick="removeAnswer(this)">×</button>
                    </div>
                    <div class="explanation-input">
                        <label>Explanation ${answerCount}</label>
                        <input type="text" class="form-control" placeholder="Nh?p gi?i thích cho câu tr? l?i ${answerCount}">
                    </div>
                `;
            ...
            function removeAnswer(button) {
                ...
                if (container.children.length > 1) {
                    ...
                    alert('Ph?i có ít nh?t m?t câu tr? l?i');
                }
            }
            ...
            function updateAnswerLabels() {
                ...
                answerGroups.forEach((group, index) => {
                    ...
                    answerInput.placeholder = `Nh?p câu tr? l?i ${index + 1}`;
                    explanationInput.placeholder = `Nh?p gi?i thích cho câu tr? l?i ${index + 1}`;
                });
            ...
            function saveQuestion() {
                ...
                console.log('D? li?u form:', formData);
                alert('?ã l?u thành công! Ki?m tra console ?? xem d? li?u.');
            }
        </script>
    </body>
</html>